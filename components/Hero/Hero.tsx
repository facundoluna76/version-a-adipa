...
export function Hero() {
  ...
  return (
    <section
      className="hero-gradient relative overflow-hidden pb-16 pt-12"
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        {/* Trust indicators */}
        <div className="mb-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-white/70">
        ...
        {/* Search bar */}
        <form onSubmit={handleSearch} className="mx-auto mb-5 max-w-2xl" role="search">
          <div className="flex overflow-hidden rounded-full bg-white shadow-2xl shadow-adipa-purple/30">
            ...
            <button
              type="submit"
              aria-label="Buscar"
              className="flex items-center justify-center bg-adipa-cyan px-6 text-white transition-colors hover:bg-adipa-cyan-600"
            >
              <Search size={20} />
            </button>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          ...
          {QUICK_SEARCH_TAGS.map((tag) => (
            <button
              ...
              className="rounded-full border border-white/30 px-3 py-1 text-xs font-medium text-white backdrop-blur-sm transition-all hover:border-white hover:bg-white/10"
            >
              {tag}
            </button>
          ))}
